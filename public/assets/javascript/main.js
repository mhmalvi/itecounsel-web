...
;(function($) {
   ...
   'use strict'
    ...
    //     if( retina ) {
    //         $( '.header .logo' ).find('img').attr( {src:"assets/images/ITEC_logo_Final.png",style:'max-width: 80px;'} );   
    //         $( '.title-section .icon' ).find('img').attr({src:"assets/images/ITEC_logo_Final.png",style:'max-width: 80px;'});
    //     }
    };    
