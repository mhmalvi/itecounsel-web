                    ...
                    <div class="col-md-9 mx-auto">
                        <article class="entry">
                            <div class="feature-post">
                                <img src="{{asset('public/storage/blogs/'.$blog->thumbnail)}}" alt="image">
                            </div>
                            <div class="main-post">
                                <h2 class="title-post"><a href="{{route('blogDetail', $blog->blog_slug)}}">{{$blog->blog_title}}</a></h2>
                                <hr>
                                <div class="meta-post clearfix">
                                    <ul>
                                        <li class="post-author">
                                            <span><a href="#">By {{$blog->user->name}}</a></span>
                                        </li>
                                        <li class="post-date">{{$date}}</li>
                                        <li class="post-categories">
                                            <a href="javascript:void(0)">@if(isset($blog->category->category)){{$blog->category->category}}@else {{"uncategorised"}} @endif</a>
                                        </li>
                                    </ul>
                                </div>
                                <hr>
...
?>
    <div style="text-align: center; padding: 25px;">
        <h2 class="text-secondary">Whoops!!! We couldn't found any content.</h2>

        <a href="{{URL::to('/')}}">return to home</a>
    </div>
<?php
    }
?>
